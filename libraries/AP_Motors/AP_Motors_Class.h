...
public:
    ...
    void                set_b_pitch(int16_t b_pitch_in){ _b_pitch_input = b_pitch_in; };                //RUAS, range 0 ~ 1000
    ...
    float               get_b_pitch() const { return _b_pitch_input; } // RUAS
...
protected:
    ...
    float               _b_pitch_input;             // RUAS, variable to set collective, 1100 ~ 1900
